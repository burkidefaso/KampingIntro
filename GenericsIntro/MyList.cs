...
namespace GenericsIntro
{
    class MyList<T>            // Generic Class
    {
        ...
        {
            T[] tempArray = items;                              // Yukarda T[] tempArray;  tanımlayıp    tempArray = items;  de yapabilirdik      // Aşağıda new dediğimizde yani dizinin eleman sayısını 1 arttırdığımızda eski değerler siliniyor çünkü yeni referans numarası alıyoruz. Bu yüzden geçici dizi tanımlayıp bu geçici diziye kaydediyoruz eski elemanları ki new dediğimizde eskiler silinmesin geçici olarak hafızada tutsun eskileri
